...
case "$1" in
  ...
  machine)
    LD_LIBRARY_PATH="$LD_LIBRARY_PATH" \
      ...
      -e "$SC_MACHINE_PATH/lib/extensions;$SCL_MACHINE_PATH/lib/extensions;$NON_ATOMIC_ACTION_INTERPRETER_MODULE_PATH/lib/extensions;$PROJECT_ROOT_PATH/build/Release/extensions;" -c ostis-example-app.ini
    ;;
  web)
